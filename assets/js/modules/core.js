    ...
    const Core = {
        ...
        cacheElements: function() {
            this.widget.elements = {
                ...
                editFeedbackBtn: document.getElementById('wpvfh-edit-feedback-btn'),
                ...
                detailPinInfo: document.getElementById('wpvfh-detail-pin-info'),
                pinSelectorValue: document.getElementById('wpvfh-pin-selector-value'),
                pinPositionValue: document.getElementById('wpvfh-pin-position-value'),
                pinPageValue: document.getElementById('wpvfh-pin-page-value'),
                ...
                attachmentsSection: document.getElementById('wpvfh-attachments-section'),
                linksSection: document.getElementById('wpvfh-links-section'),
                linksList: document.getElementById('wpvfh-links-list'),
                linkUrlInput: document.getElementById('wpvfh-link-url'),
                addLinkBtn: document.getElementById('wpvfh-add-link-btn'),
                linksData: document.getElementById('wpvfh-links-data'),
