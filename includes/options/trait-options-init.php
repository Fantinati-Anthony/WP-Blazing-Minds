<?php
/**
 * Trait pour l'initialisation, menu et scripts du gestionnaire d'options
 *
...
/**
 * Trait pour l'initialisation du gestionnaire d'options
 *
 * @since 1.7.0
 */
trait WPVFH_Options_Init_Trait {
